...
export default {
  ...
  computed: {
    actionDisabled() {
      ...
      const isChanged =
        JSON.stringify(settings) === JSON.stringify(this.currentSettings)
  ...
  methods: {
    ...
    setItem(item, itemSetting, val) {
      this[item] = val
      this.$store.dispatch('itemSet', {
        ...this.$store.state.boardSettings.item,
        [itemSetting]: val,
      })
    },
    setUnit() {
    ...
    toggleItemlistPreview() {
      const items = [
        {
          content_date: '1999-09-19 09:19:19',
      ...
      if (this.itemlistPreview) {
        this.$refs.settingItem.$el.scrollIntoView({
          behavior: 'smooth',
          block: 'start',
          inline: 'nearest',
        })
...
<template>
  <v-card outlined class="" ref="settingItem" class="item-settings">
    <v-card-title class="text-h4 primary--text">
      Item list
    </v-card-title>
    <v-card-text class="d-flex flex-column align-start">
      <EventList
        v-if="itemlistPreview"
        class="eventList"
        sheetHeight="40em"
        v-scroll="onScroll"
      ></EventList>
        ...
        <v-sheet color="transparent" class="d-flex flex-column align-start">
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('headerColor', 'itemListHeaderColor', $event)"
                :btnProps="{ color: headerColor }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('color', 'itemColor', $event)"
                :btnProps="{ color: color }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          ...
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('title', 'itemTextTitle', $event)"
                :btnProps="{ color: title }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          ...
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('subtitle', 'itemTextSubtitle', $event)"
                :btnProps="{ color: subtitle }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('description', 'itemTextDescription', $event)"
                :btnProps="{ color: description }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('footer', 'itemTextFooter', $event)"
                :btnProps="{ color: footer }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
        </v-sheet>
        <!-- header text, active card colors -->
        <v-sheet
          color="transparent"
        ...
        >
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="
                  setItem('headerTextColor', 'itemListHeaderTextColor', $event)
                "
                :btnProps="{ color: headerTextColor }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          ...
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('colorActive', 'itemColorActive', $event)"
                :btnProps="{ color: colorActive }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('titleActive', 'itemTextTitleActive', $event)"
                :btnProps="{ color: titleActive }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="
                  setItem('subtitleActive', 'itemTextSubtitleActive', $event)
                "
                :btnProps="{ color: subtitleActive }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="
                  setItem(
                    'descriptionActive',
                    'itemTextDescriptionActive',
                    $event,
                  )
                "
                :btnProps="{ color: descriptionActive }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
          <v-card flat class="">
            ...
            <v-card-text class="d-flex flex-column align-start">
              ...
              <Colorpicker
                @input="setItem('footerActive', 'itemTextFooterActive', $event)"
                :btnProps="{ color: footerActive }"
              ></Colorpicker>
            </v-card-text>
          </v-card>
        </v-sheet>
    ...
    <v-card-actions class="pa-4">
      ...
      <v-btn
        tile
        :color="itemlistPreview ? 'primary' : 'disabled'"
        @click="toggleItemlistPreview"
